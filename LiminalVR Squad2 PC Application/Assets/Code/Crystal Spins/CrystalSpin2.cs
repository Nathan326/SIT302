...
public class CrystalSpin2 : MonoBehaviour
{
    public bool rotateObject = false;
    public bool playMusic = false;

    public AudioClip Crystal2Clip;

    public AudioSource Crystal2Source;

    // Start is called before the first frame update
    void Start()
    {
        GetComponent<Behaviour>().enabled = false;
        Crystal2Source.clip = Crystal2Clip;
    }
    ...
    void Update()
    {
        ...
        {
            if (hit.collider.gameObject.name == "Crystal2")
            {
